...
int main(int argc, char const *argv[])
{
    ...
    Gemm gemm_op;
    cutlass::TensorRef<ElementInputA, LayoutInputA> A_ref({A_ptr, K});
    cutlass::TensorRef<ElementInputB, LayoutInputB> B_ref({B_ptr, K});
    cutlass::TensorRef<ElementOutput, LayoutOutput> C_ref({C_ptr, N});
